<div class="span9">
	<div class="content">
			...
			if (isset($_GET['kriteria_aksi'])) {
				...
				?>
					<div class="module">
						<div class="module-body">
							<center>
								<h3>Tambah Kriteria <?php echo $pen['lowongan']; ?></h3>
							</center>
							<form class="form-horizontal row-fluid" action="" method="post">
								<div class="control-group">
		...
		----------------------------------*/
				...
				<div class="module">
					<div class="module-head">
						<h3>Kriteria <?php echo $row['lowongan'];
										echo " <a class='btn btn-small btn-primary' href='?menu=penerimaan&kriteria=$id_lowongan&kriteria_aksi=tambah'>Tambah</a>"; ?> </h3>
					</div>
		...
		----------------------------------*/
			...
			<div class="module">
				<div class="module-head">
					<h3>Data Kriteria <a class="btn btn-primary" href="?menu=penerimaan&aksi=tambah">Tambah</a> </h3>
				</div>
				<div class="module-body table">
